...
const target = useTemplateRef('search-container')
...
<template>
  <nav class="navbar navbar-expand navbar-dark bg-dark mb-4 navcolor">
    <div class="container my-auto">
      <RouterLink class="navbar-brand" to="/">FakeSocial</RouterLink>
      <div class="navbar-nav mr-auto">
        <RouterLink class="navbarButton nav-link mr-auto" to="/search">Поиск</RouterLink>
      </div>
